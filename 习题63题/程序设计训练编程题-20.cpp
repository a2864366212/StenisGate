...
stringstream ss;
void stringtollint(string & s,long long int& result)
{
	ss<<s;
	ss>>result;
	ss.clear();
...
void answer(string & str,long long int *num,long long int *TenMicifang)
{
...
long long int num[15]={0};
long long int TenMicifang[15]={0};
int main()
{
	int group;
	cin>>group;
